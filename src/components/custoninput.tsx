...
export default function CustomInput({
  ...
  const inputColorsClass: Record<Color, [string, string]> = {
    sky: ['focus:border-sky-700 focus:text-sky-700', 'peer-focus:text-sky-700'],
    neutral: [
